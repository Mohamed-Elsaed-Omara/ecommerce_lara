...
(function($) {
  ...
  $('#add-to-cart-form').submit(function(e){
    ...
    $.ajax({
      ...
      toastr.success('The product has been added to the cart');   
      },
      error: function(data){
...
$(function(){
  let productRate = $('#v-rate').data('pid')
  $(".u-rating").starRating({
    starSize:25,
    readOnly:true,
    initialRating:productRate
...
$(function(){
  let productRate = $('#g-rate').data('pid')
  $(".pp-rating").starRating({
    starSize:20,
    readOnly:true,
    initialRating:productRate
  })
